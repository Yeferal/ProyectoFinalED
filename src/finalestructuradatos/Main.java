...
import ventanas.VentanaGraficasArbol;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //VentanaGraficasArbol ventanaGraficasArbol = new VentanaGraficasArbol(inicio);
...
//        String contenido = ar.busqueda();
//        String ruta = "Graficas/arbol.dot";
//        a.crearArchivo(contenido,ruta);
//        
//        String comando = "dot -Tjpg Graficas/arbol.dot -o Graficas/arbol.jpg";
//        Runtime rt = Runtime.getRuntime();
//      
//        rt.exec( comando );
        
        //ventanaGraficasArbol.setGrafica("Graficas/arbol.jpg");
        //ventanaGraficasArbol.setVisible(true);
